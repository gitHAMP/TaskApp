INSERT INTO tasks (id, content, status, title) VALUES
  ...
  ( 1005, '(6)Complete the Application.properties file and create a new schema in your sql workbench', 'CLOSED', 'Database and Application Properties'),
